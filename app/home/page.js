    ...
    <>
      ...
      <main className='flex flex-col m-auto py-8 px-4 max-sm:px-0 max-sm:py-2'>
        ...
        <article className='flex flex-col m-auto py-8 px-4 max-sm:px-0 max-sm:py-2'>
          ...
          <blockquote className='block text-3xl text-right text-accent-300 px-4 font-thin max-sm:text-lg'>
            &apos;Discipline is the bridge between goals and
            accomplishment.&apos;
            <cite className='font-semibold'> (Eliud Kipchoge)</cite>
          </blockquote>
          <p className='text-justify text-3xl m-4 pb-12 border-b-2 font-normal text-primary-300 max-sm:text-lg'>
        ...
        <article className='flex flex-col m-auto py-8 px-4'>
          ...
          <p className='text-justify text-3xl m-4 pb-8 border-b-2 font-normal text-primary-300 max-sm:text-lg'>
